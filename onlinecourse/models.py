...
# Task 2: New Exam-Related Models
class Question(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    question_text = models.CharField(max_length=1000, default="Enter question text here")
...
class Choice(models.Model):
    ...
    choice_text = models.CharField(max_length=1000, default="Enter choice text here")
